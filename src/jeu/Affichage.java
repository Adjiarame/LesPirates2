...
public class Affichage {
    ...
    public void afficherPiocherCartes(String nomJoueur, Cartes carte) {
        System.out.println(nomJoueur + " pioche : " + carte.getNom() + " " + carte.getEffet());
    }
    ...
    public void afficherCartes(Cartes[] main) {
        ...
        for (int i = 0; i < main.length; i++) {
            if (main[i] != null) {
                System.out.println((i + 1) + ". " + main[i].getNom() + " " + main[i].getEffet());
            }
        }
    }
